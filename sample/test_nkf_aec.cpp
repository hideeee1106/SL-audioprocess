...
int main(int argc, char *argv[]){
    ...
    SL_EchoCancelFilter* filter = SL_CreateEchoCancelFilter(model_path);
    ...
    for (int i = 0; i < process_num; ++i) {
        ...
        SL_EchoCancelFilterForWav1C16khzSingle(filter,&inputfile.samples[0][i*256],&inputlpbfile.samples[0][i*256],outputs);
